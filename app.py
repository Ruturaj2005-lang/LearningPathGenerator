...
calendar_url = st.sidebar.text_input("Google Calendar", placeholder="Enter Pipedream Calendar URL")

# Info Guide
st.info("""
**Quick Guide**  
1. Enter your Google API key and YouTube URL  
2. Optionally add Drive, Notion, or Calendar integration  
...
def update_progress(msg: str):
    ...
    section_map = {
        ...
        "Added Google Calendar integration": ("Integration", 0.2),
    ...
    if not google_api_key:
        ...
        try:
            result = run_agent_sync(
                ...
                calendar_pipedream_url=calendar_url,
                user_goal=user_goal,
